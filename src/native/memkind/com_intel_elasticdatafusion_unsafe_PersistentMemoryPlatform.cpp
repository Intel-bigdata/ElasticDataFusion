...
#include <cassert>
#include <stdexcept>
#include "com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform.h"
...
JNIEXPORT void JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_initializeKmem
  (JNIEnv *, jclass) {
  pmemkind = MEMKIND_DAX_KMEM;
}

JNIEXPORT void JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_initializeNative
...
JNIEXPORT void JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_setNUMANode
...
JNIEXPORT jlong JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_allocateVolatileMemory
...
JNIEXPORT jlong JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_getOccupiedSize
...
JNIEXPORT void JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_freeMemory
  (JNIEnv *env, jclass clazz, jlong address) {
  check(env);
  memkind_free(pmemkind, addr_from_java(address));
}

JNIEXPORT void JNICALL Java_com_intel_elasticdatafusion_unsafe_PersistentMemoryPlatform_copyMemory
